...
public class Main extends BaseActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// 初始化登录
		appContext.initLoginInfo();      //本地获取cookies信息

		this.initHeadView();    //初始化头部view
		this.initFootBar();     //初始化底部view
		this.initPageScroll();		//初始化选项卡
		this.initFrameButton();		//初始化滑屏各View
		this.initBadgeView();     //通知信息标签控件?
